...
*   **VCF Files** (Optional): Germline SNPs, bgzipped and indexed (`.tbi`). Required for GIS and allele-specific copy number.
*   **Target BED** (Panel): BED file defining target regions.
