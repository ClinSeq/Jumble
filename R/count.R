...
#' @keywords internal
#' @importFrom GenomicRanges makeGRangesFromDataFrame reduce gaps start<- end<- width strand trim seqnames
...
create_background_bins <- function(raw_targets, chromlength) {
  ...
  # Filter out empty + and - strand assumptions generated by gaps()
  gr_bg <- gr_bg[strand(gr_bg) == "*"]
